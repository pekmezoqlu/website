  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2.5 flex items-center gap-1.5 text-xs text-gray-500 overflow-x-auto whitespace-nowrap">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        {/* İlan başlığı */}
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 uppercase leading-snug">
          {urun.modelYili} Model {urun.marka} {urun.model}
          {urun.saat !== "-" ? ` — ${urun.saat}` : ""}
        </h1>
        ...
        <div className="grid lg:grid-cols-5 gap-5">
          ...
          {/* Sağ: Fiyat + Tablo + İletişim */}
          <div className="lg:col-span-2 flex flex-col gap-4">

            {/* Fiyat & Konum */}
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              <p className="text-2xl font-extrabold text-red-600 mb-1">Fiyat İçin Arayın</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              {tablo.map((satir, i) => (
                <div
                  key={satir.label}
                  className={`flex items-center text-sm ${i < tablo.length - 1 ? "border-b border-gray-100" : ""}`}
                >
                  <div className="w-2/5 px-4 py-2.5 bg-gray-50 text-gray-500 font-medium text-xs shrink-0">
                    {satir.label}
                  </div>
                  <div className="w-3/5 px-4 py-2.5 text-gray-900 font-semibold text-sm">
                    {satir.value}
                  </div>
                </div>
              ))}
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-200">
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-gray-100 mb-4">
                ...
                <div>
                  <p className="font-bold text-sm text-gray-900 leading-tight">Pekmezoğlu Motorlu Araçlar</p>
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <a
                  ...
                  className="flex items-center justify-between bg-green-500 hover:bg-green-600 text-white font-semibold px-4 py-3 rounded-xl transition-colors"
                >
                  <div className="flex items-center gap-2">
