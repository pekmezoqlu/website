  ...
  return (
    <>
      ...
      <section className="bg-white border-b border-gray-200 sticky top-16 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex gap-2 overflow-x-auto" style={{ scrollbarWidth: "none" }}>
          {markalar.map((m) => (
            <button
              key={m}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {urunler.map((urun) => (
              ...
              >
                {/* Görsel */}
                <div className={`${urun.fotolar.length > 0 ? "bg-black" : urun.renk} relative overflow-hidden`} style={{ aspectRatio: "9/16" }}>
