          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+905359878980" className="hover:text-red-600 transition-colors">0535 987 89 80</a>
              </li>
              <li className="flex items-start gap-2">
                ...
                <a href="https://wa.me/905359878980" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors">WA: 0535 987 89 80</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-red-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:pekmezoglu@hotmail.com.tr" className="hover:text-red-600 transition-colors">
