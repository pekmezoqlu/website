      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li className="flex items-start gap-2">
                ...
                75. Yıl (Sultandere) Mah. Oto Galericiler Sitesi No: 467/7, Odunpazarı / Eskişehir
              </li>
              <li className="flex items-start gap-2">
                ...
                <div className="flex flex-col gap-0.5">
                  <a href="tel:+905457280424" className="hover:text-white transition-colors">0545 728 04 24</a>
                  <a href="tel:+905359878980" className="hover:text-white transition-colors">0535 987 89 80</a>
                </div>
              </li>
              <li className="flex items-start gap-2">
                ...
                <div className="flex flex-col gap-0.5">
                  <a href="https://wa.me/905457280424" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">WA: 0545 728 04 24</a>
                  <a href="https://wa.me/905359878980" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">WA: 0535 987 89 80</a>
                </div>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:pekmezoglu@hotmail.com.tr" className="hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium px-4 py-2 rounded-full transition-colors"
          >
