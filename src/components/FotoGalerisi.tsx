...
export default function FotoGalerisi({ fotolar, baslik }: Props) {
  ...
  if (fotolar.length === 0) {
    return (
      <div className="bg-gray-100 rounded-xl flex items-center justify-center" style={{ aspectRatio: "3/4" }}>
  ...
  return (
    ...
    <div className="space-y-2">
      {/* Ana fotoğraf */}
      <div
        className="relative bg-white rounded-xl overflow-hidden aspect-[3/4] cursor-zoom-in"
