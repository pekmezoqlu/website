            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filtrelenmis.map((urun, i) => (
                <FadeIn key={urun.id} delay={(i % 4) * 80}>
                  <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-red-100 hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 border border-gray-100 hover:border-red-200 group">
                    ...
                    <div className="p-5">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm font-semibold">
                        ...
                        <a
                          ...
                          className="flex items-center justify-center rounded-xl bg-green-500 px-3 py-2.5 text-center text-white hover:bg-green-600 transition-colors"
                        >
