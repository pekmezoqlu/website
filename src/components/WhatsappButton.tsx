...
export default function WhatsappButton() {
  ...
  return (
    <div className="fixed bottom-4 right-3 md:bottom-8 md:right-7 z-50 flex flex-col items-end gap-2">
      {/* Numara seçim kutusu */}
      {acik && (
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-4 w-64 animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <div className="flex flex-col gap-2">
            {NUMARALAR.map((n) => (
              <a
                ...
                className="flex items-center gap-3 bg-green-50 hover:bg-green-100 rounded-xl px-4 py-3 transition-colors group"
              >
          ...
          <p className="text-xs text-gray-400 text-center mt-3">Tıkla, WhatsApp açılsın</p>
        </div>
      )}
